...
{		
	...
	SDL_Surface* head_UP = NULL;
	SDL_Surface* head_DOWN = NULL;
	SDL_Surface* head_LEFT = NULL;
	SDL_Surface* head_RIGHT = NULL;
	SDL_Surface* tail_UP = NULL;
	SDL_Surface* tail_DOWN = NULL;
	SDL_Surface* tail_LEFT = NULL;
	SDL_Surface* tail_RIGHT = NULL;
	...
	//Chargement d'image
	mur = IMG_Load("sprites/wall.png");
	caisse = IMG_Load("");
	
	head_UP = IMG_Load("sprites/head_UP.png");
	head_DOWN = IMG_Load("sprites/head_DOWN.png");
	head_LEFT = IMG_Load("sprites/head_LEFT.png");
	head_RIGHT = IMG_Load("sprites/head_RIGHT.png");
	
	tail_UP = IMG_Load("sprites/tail_UP.png");
	tail_DOWN = IMG_Load("sprites/tail_DOWN.png");
	tail_LEFT = IMG_Load("sprites/tail_LEFT.png");
	tail_RIGHT = IMG_Load("sprites/tail_RIGHT.png");
	
	background = IMG_Load("images/Background.jpg");
	pomme = IMG_Load("sprites/apple.png");
